    ...
    defaultMenu: IMenuItem[] = [
        {   
            ...
            sub: [
                ...
                { icon: 'i-Over-Time', name: 'dashboard', state: '/dashboard/v3', type: 'link' },
        ...
        // },
        {
            ...
            // name: 'Forms',
            sub: [
                { icon: 'i-File-Clipboard-Text--Image', name: 'Student Components', state: '/forms/basic', type: 'link' },
        ...
        },
        {
            ...
            sub: [
                ...
                { icon: 'i-Code-Window', name: 'Api-data', state: '/tables/paging', type: 'link' },
                { icon: 'i-Filter-2', name: 'Datatable', state: '/tables/filter', type: 'link' },
                // { icon: 'i-Filter-2', name: 'Api data', state: '/tables/api', type: 'link' },
            ]
        },
        {
            name: 'Sessions',
